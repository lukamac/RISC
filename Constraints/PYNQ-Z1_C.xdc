...
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { rgb[1] }]; #IO_L22P_T3_AD7P_35 Sch=led5_g
...
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { tx }]; #IO_L22P_T3_34 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { rx }]; #IO_L22N_T3_34 Sch=ja_n[4]
